...
@Component({
  ...
  <div nz-row id="signform" [nzGutter]="[16, 24]">
    <div nz-col nzSpan="24">
    <form nz-form [formGroup]="validateForm" (ngSubmit)="submitForm()">
      <nz-form-item><div id="signup"><h1>SignUp</h1></div>
      ...
      <nz-form-item nz-row class="register-area">
        <nz-form-control [nzSpan]="14" [nzOffset]="6">
          <button nz-button [routerLinkActive]="'profile'" nzType="primary"  nzShape="round">Registrati</button>
        </nz-form-control>
      </nz-form-item>
    </form>
    </div>
